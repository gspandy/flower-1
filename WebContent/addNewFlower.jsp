	...
	<div class="content">
		...
		<div class="right">
			<div style="padding-left:200px;width: 600px;">
				...
				<s:form action="/admin/addOrUpdateFlower.action" method="post"
					...
					<s:select label="分类" list="#request.catalogs" 
					listKey="catalogid" listValue="catalogname" name="flower.catalog.catalogid"
