...
<div class="divContent">
	<span class="spanPrice">支付金额： $ </span><span class="price_t">&yen;${session.cart.totalPrice }</span>
	<span class="spanOid">编号：${request.order.orderid}</span>
</div>
<form action="<c:url value='/OrderServlet.servlet'/>" method="post" id="form1" target="_top">
<input type="hidden" name="method" value="pay"/> 
 <input type="hidden" name="oid" value="${request.order.orderid }"/>
<div class="divBank">
	<div class="divText">选择网上支付</div>
	<div style="margin-left: 20px;">
	  ...
	  <div style="margin-bottom: 20px;">
		...
		<img name="HXB-NET-B2C" align="middle" src="<c:url value='/bank_img/zheshang.bmp'/>"/>

		<input id="CZ-NET-B2C" type="radio" name="yh" value="CZ-NET-B2C"/>
		<img name="CZ-NET-B2C" align="middle" src="<c:url value='/bank_img/hx.bmp'/>"/> 
	  </div>
