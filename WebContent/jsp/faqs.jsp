	...
	<div id="templatemo_header" class="header_subpage">
        ...
        <div id="templatemo_menu" class="ddsmoothmenu">
            <ul>
                ...
                <li><a href='<c:url value="/jsp/contact.jsp"></c:url>'>关于</a></li>
            ...
            <div id="templatemo_search">
                <form action='<c:url value="searchFlower"></c:url>' method="get">
                  	<input type="text" value="Site Search" name="flower.flowername" id="keyword" title="keyword" 
        ...
        <a href="http://www.gsunny.cn" title="免费的图像搜索"  class="site_repeat" ><img src="images/top_repeat.png" title="免费的图像搜索" alt="免费的图像搜索" /></a><!-- end of templatemo_menu -->
