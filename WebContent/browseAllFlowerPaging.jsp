						...
						元 <br>
						 <input type="hidden" name="flowerid"
							value="<s:property value="#flower.flowerid" />">
							 ...
							 <input type="submit" value="修改" onclick="this.form.action='/sshFlower/admin/displayOneFlower'" />
							  <input type="submit" value="删除" onclick="this.form.action='/sshFlower/admin/deleteOneFlower'" />
					</form>
				</div>
			</s:iterator>
		</div>
